...
static arm_matrix_instance_f32 E;      // Error(k) = y(k) - aux4 -> 1 x 1
static arm_matrix_instance_f32 P;      // P(k) = P(k-1) - M8 -> M_SIZE x M_SIZE
static arm_matrix_instance_f32 T;      // Theta(k) = Theta(k-1) - aux5 -> M_SIZE x 1
static arm_matrix_instance_f32 F;      // Phi(k) -> 1 x M_SIZE
static arm_matrix_instance_f32 K;      // K(k) = aux0/aux4 -> M_SIZE x 1
static arm_matrix_instance_f32 TT;     // Theta'(k) -> 1 x M_SIZE
static arm_matrix_instance_f32 FT;     // Phi'(k) -> M_SIZE x 1

static arm_matrix_instance_f32 aux0;   // aux0 = P(k-1) Phi'(k) -> M_SIZE x 1
static arm_matrix_instance_f32 aux1;   // aux1 = Phi(k) aux0 -> 1 x 1
static arm_matrix_instance_f32 aux2;   // aux2 = Phi(k) P(k-1) -> 1 x M_SIZE
static arm_matrix_instance_f32 aux3;   // aux3 = K(k) aux2 -> M_SIZE x M_SIZE
static arm_matrix_instance_f32 aux4;   // aux4 = Phi(k) Theta(k-1) -> 1 x 1
static arm_matrix_instance_f32 aux5;   // aux5 = K(k) Error(k) -> 1 x 1
